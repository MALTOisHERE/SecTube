      ...
      <div className="text-center max-w-md">
        <div className="mb-6 flex justify-center">
          <div className="w-20 h-20 bg-dark-900 border border-dark-800 rounded-full flex items-center justify-center">
            <FaBookmark className="text-gray-500" size={32} />
          </div>
        </div>
        <h1 className="text-2xl font-semibold text-white mb-3">Saved Videos</h1>
        <p className="text-sm text-gray-400 mb-6">
          This feature is coming soon. You'll be able to save your favorite videos and access them quickly from this page.
        </p>
